        ...
        <Card.Body>
          ...
          <Card>
            <Card.Body>
              ...
              <Card.Text>
                I participated in the creation of <Card.Link href='/project1' target="_blank">Becoming a Better Student</Card.Link>,
                and <Card.Link href='/project2' target="_blank">Project Survivor</Card.Link> in a group consisting of Isaac 
                Smith, Nathan Lambert, Jaren Brownlee, and I. Later, I worked on the projects
                <Card.Link href='/project3' target="_blank">PickShip</Card.Link> and this website portofolio on my own Overall, I put
